// =============================================================
// Mock data — realistic fake data for building and testing the UI
...
export const mockPlans: Plan[] = [
  {
    ...
    rationale: "Build GitHub ingestion in 3 subtasks: fetch PRs, normalize data, fetch CI status.",
  ...
  },
  {
    ...
    rationale: "Build developer dashboard with task list, draft viewer, and risk panel.",
    approved_by_id: null,
    approved_at: null,
    rejection_reason: null,
    version: 1,
