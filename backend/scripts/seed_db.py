...
async def seed_database():
    ...
    async with async_session() as session:
        ...
        project1 = Project(
            ...
            description="Full-stack e-commerce platform with React frontend, FastAPI backend, Stripe payments, and AI-powered product recommendations. Targeting launch for 1000+ concurrent users with WCAG 2.1 AA accessibility.",
            owner_id=pm_id,
            goals=[
            ...
            milestones=[
                "M1: Foundation (auth, teams, projects) — COMPLETED",
                "M2: Core Agent Pipeline (orchestrator, inference, reviewer) — COMPLETED",
                "M3: Billing & Marketplace (Stripe, Paid.ai, agent catalog) — COMPLETED",
                "M4: Integration & QA (GitHub sync, E2E tests, seed data) — IN PROGRESS",
                "M5: Polish & Demo (start flow, context explorer, connections) — IN PROGRESS",
            ],
        ...
        github_ctx = GitHubContext(
            ...
            pull_requests=[
                {
                    "number": 48,
                    "title": "feat: add shopping cart with real-time price updates",
                    "state": "open",
                    "author": "dev_charlie",
                ...
                {
                    "number": 47,
                    "title": "feat: product catalog filtering and pagination",
                    "state": "open",
                    "author": "dev_charlie",
                    "head_branch": "feature/catalog-filters",
                    "base_branch": "main",
                    "additions": 540,
                    "deletions": 67,
                    "changed_files": 12,
                    "labels": ["feature", "frontend", "in-review"],
                    "has_conflicts": False,
                },
                {
                    "number": 46,
                    "title": "fix: payment endpoint SQL injection vulnerability",
                    "state": "open",
                    "author": "dev_bob",
                    "head_branch": "fix/payment-sqli",
                    "base_branch": "main",
                    "additions": 45,
                    "deletions": 18,
                    "changed_files": 3,
                ...
                {
                    "number": 45,
                    "title": "chore: CI/CD pipeline with GitHub Actions",
                    "state": "open",
                    "author": "dev_bob",
                    "head_branch": "chore/ci-pipeline",
                    "base_branch": "main",
                    "additions": 210,
                    "deletions": 0,
                    "changed_files": 5,
                ...
                {
                    "number": 44,
                    "title": "feat: product search API with full-text indexing",
                    "state": "merged",
                    "author": "dev_bob",
                    "head_branch": "feature/search-api",
                    "base_branch": "main",
                    "additions": 380,
                    "deletions": 22,
                    "changed_files": 8,
                ...
                },
                {
                    ...
                    "state": "merged",
                    "author": "dev_charlie",
                    "head_branch": "feature/product-catalog",
                    "base_branch": "main",
                    "additions": 340,
                    "deletions": 12,
                    "changed_files": 9,
            ...
            recent_commits=[
                {"sha": "f8a2c91", "message": "feat: add CartContext provider with localStorage persistence", "author": "dev_charlie"},
                {"sha": "e7b3d82", "message": "feat: CartSummary component with quantity controls", "author": "dev_charlie"},
                {"sha": "d6c4e73", "message": "fix: parameterized queries for payment search endpoint", "author": "dev_bob"},
                {"sha": "c5d5f64", "message": "feat: add category filter with debounced search input", "author": "dev_charlie"},
                {"sha": "b4e6a55", "message": "feat: cursor-based pagination for product list API", "author": "dev_bob"},
                {"sha": "a3f7b46", "message": "chore: add GitHub Actions workflow for pytest + lint", "author": "dev_bob"},
                {"sha": "92a8c37", "message": "feat: ProductCard component with add-to-cart button", "author": "dev_charlie"},
                {"sha": "81b9d28", "message": "feat: full-text search with PostgreSQL tsvector", "author": "dev_bob"},
                {"sha": "70c0e19", "message": "fix: token rotation on refresh to prevent reuse attacks", "author": "dev_bob"},
                {"sha": "6fd1f0a", "message": "refactor: extract payment validation into service layer", "author": "dev_bob"},
            ],
            ci_status=[
                {"name": "pytest", "conclusion": "success", "pr_number": 48, "workflow": "tests"},
                {"name": "eslint", "conclusion": "success", "pr_number": 48, "workflow": "lint"},
                {"name": "pytest", "conclusion": "success", "pr_number": 47, "workflow": "tests"},
                {"name": "eslint", "conclusion": "success", "pr_number": 47, "workflow": "lint"},
                {"name": "pytest", "conclusion": "success", "pr_number": 46, "workflow": "tests"},
                {"name": "security-scan", "conclusion": "success", "pr_number": 46, "workflow": "security"},
                {"name": "pytest", "conclusion": "failure", "pr_number": 45, "workflow": "tests"},
                {"name": "docker-build", "conclusion": "pending", "pr_number": 45, "workflow": "build"},
                {"name": "pytest", "conclusion": "success", "workflow": "tests"},
                {"name": "eslint", "conclusion": "success", "workflow": "lint"},
            ],
        )
        session.add(github_ctx)
        print(f"  Created GitHub context for project 1 (7 PRs, 10 commits, 10 CI checks)")
